...
/**
 * Login come Benfiga (t2, presidente) e attende che la schermata partecipante sia pronta.
 * Il login admin separato è stato eliminato: Benfiga usa il login squadra e
 * ha tutti i pannelli presidente (inclusa gestione asta) nella schermata partecipante.
 */
async function loginAdmin(page) {
  ...
  // CRITICO: aspetta auth PRIMA di cliccare login, così i listener Firebase
  // vengono registrati con auth già valida → nessun PERMISSION_DENIED iniziale.
